...
[Special build for Gree Air Condition, models with remote control is YAP0FB2]
...
DATA_KEY = 'climate.xiaomi_miio_gree'
...
def async_setup_platform(hass, config, async_add_devices, discovery_info=None):
    ...
    from .xiaomiaccompanion import XiaomiACCompanion
    ...
    try:
        device = XiaomiACCompanion(host, token,debug=5)
...
class XiaomiAirConditioningCompanion(ClimateDevice):
    ...
    def __init__(self, hass, name, device, unique_id, sensor_entity_id,
        ...
        self._current_led_status = Led.On
